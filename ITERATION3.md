...
| **M7b: Agent primitives (backlog)** | User-defined agents via markdown config files. Two agent types: COMMENT agents and DESCRIPTION agents. @agentname triggers in comments. | Follow-up minion. |
